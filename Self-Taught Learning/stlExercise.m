...
lambda = 1e-4;
options.maxIter = maxIter;
softmaxModel = softmaxTrain(hiddenSize, numLabels,...
                            lambda, trainFeatures, trainLabels, options);

% softmaxModel = softmaxTrain(inputSize, numLabels,...
